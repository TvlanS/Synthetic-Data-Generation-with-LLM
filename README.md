...
This study generates a synthetic tuberculosis (TB) dataset using structured prompt engineering with ChatGPT-5.1, replicating real-world data from 1,693 patients with 6 key features sourced from UMMC. The dataset is evaluated on fidelity, privacy, and utility.

Multiple models—Linear Regression, Lasso, Ridge, SVR, Random Forest, and Gradient Boosting—are developed and tested using TSTS and TSTR frameworks. Results show that the synthetic data preserves statistical characteristics, maintains privacy, and achieves strong predictive performance, even outperforming models trained on real data.

This highlights the viability of LLM-generated synthetic data for building accurate predictive models while addressing data accessibility and privacy challenges.
